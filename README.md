...
[![Face Photo Restorer](./public/screenshot.png)](https://revive.io/)
...
Note: I just added auth so these steps are not complete as of now. You can git clone from [this specific commit](https://github.com/Nutlope/revive/tree/1c5c8ac4f52a08f68a3091d3b21be8a65aef71f2).
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Nutlope/revive&env=REPLICATE_API_KEY&project-name=face-photo-restorer&repo-name=restore-photos)
